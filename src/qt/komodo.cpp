...
{
    return QCoreApplication::translate("elosys-core", psz).toStdString();
}
...
/** Class encapsulating Elosys Core startup and shutdown.
...
public:
    ...
    /// Get window identifier of QMainWindow (ElosysOceanGUI)
    ...
    returnValue(0)
{
    ...
    platformName = GetArg("-uiplatform", ElosysOceanGUI::DEFAULT_UIPLATFORM);
...
{
    window = new ElosysOceanGUI(platformStyle, networkStyle, 0);
...
void KomodoApplication::initializeResult(bool success)
{
    ...
    // #endif
        ...
        if (!vpwallets.empty())
        {
            ...
            window->addWallet(ElosysOceanGUI::DEFAULT_WALLET, walletModel);
            window->setCurrentWallet(ElosysOceanGUI::DEFAULT_WALLET);
        ...
        // elosys: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", ElosysOceanGUI::tr("A fatal error occurred. Elosys can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
//        SelectParams(ChainNameFromCommandLine());
    ...
    try
    {
        //The GUI config file gets read as part of the ElosysOceanGUI
        ...
        app.createWindow(networkStyle.data());
            ...
            // elosys: links repeatedly have their payment requests routed to this process:
