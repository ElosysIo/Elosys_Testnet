...
/* ElosysOceanGUI -- Size of icons in status bar */
...
/* Transaction list -- positive amount */
#define COLOR_POSITIVE_ELOSYS QColor(25, 225, 25)
...
#define QAPP_ORG_NAME "Elosys Chain"
#define QAPP_ORG_DOMAIN "elosyschain.com"
