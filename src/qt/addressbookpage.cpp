    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Elosys addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->labelExplanation->setVisible(false);
        ui->deleteAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Elosys addresses for receiving payments. It is recommended to use a new receiving address for each transaction."));
        ui->labelExplanation->setVisible(false);
