...
QList<KomodoUnits::Unit> KomodoUnits::availableUnits()
{
    ...
    unitlist.append(ELO);
    unitlist.append(mELO);
    unitlist.append(uELO);
    return unitlist;
}
...
QString KomodoUnits::name(int unit)
{
    switch(unit)
    {
    case ELO: return QString("ELO");
    case mELO: return QString("mELO");
    case uELO: return QString("uELO");
...
QString KomodoUnits::description(int unit)
{
    switch(unit)
    {
    case ELO: return QString("Coins");
    case mELO: return QString("Milli-Coins (1 / 1" THIN_SP_UTF8 "000)");
    case uELO: return QString("Micro-Coins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 KomodoUnits::factor(int unit)
{
    switch(unit)
    {
    case ELO:  return 100000000;
    case mELO: return 100000;
    case uELO: return 100;
