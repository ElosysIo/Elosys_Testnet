 ...
 * controls into ElosysOceanGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to ElosysOceanGUI, thus greatly simplifying merges while
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, ElosysOceanGUI *_gui = 0);
    ~WalletFrame();
