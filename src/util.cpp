...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2018-%i The Elosys developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Elosys Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Elosys developers") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Elosys developers";
    }
