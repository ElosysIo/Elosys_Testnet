...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("Forge1", "elosys1.cryptoforge.cc")); // Forge
        vSeeds.push_back(CDNSSeedData("Forge2", "elosys2.cryptoforge.cc")); // Forge
        vSeeds.push_back(CDNSSeedData("Forge3", "elosys3.cryptoforge.cc")); // Forge
        vSeeds.push_back(CDNSSeedData("ForgeExporer", "explorer.cryptoforge.cc")); // Forge
        vSeeds.push_back(CDNSSeedData("Explorer","explorer.elosyschain.com")); // Explorer tls enabled chmex
