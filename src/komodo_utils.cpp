...
void komodo_args(char *argv0)
{
    ...
    SoftSetArg("-ac_name", std::string("ELOSYS"));
    ...
    vector<string> ELOSYSnodes = {"elosys1.cryptoforge.cc,elosys2.cryptoforge.cc,elosys3.cryptoforge.cc,explorer.elosyschain.com","78.63.47.105","46.4.67.239","139.99.145.129","94.130.32.156","173.212.200.221","66.248.204.186","91.206.15.138","217.69.15.197","38.91.101.236","49.12.83.114","158.69.26.155","51.81.56.52","84.38.184.139" };
    mapMultiArgs["-addnode"] = ELOSYSnodes;
    ...
    if ( !chainName.isKMD() )
    {
        ...
        if ( chainName.isSymbol("ELOSYS") && ASSETCHAINS_HALVING[0] == 77777 )
        {
            ASSETCHAINS_HALVING[0] *= 5;
            fprintf(stderr,"ELOSYS halving changed to %d %.1f days ASSETCHAINS_LASTERA.%llu\n",(int32_t)ASSETCHAINS_HALVING[0],(double)ASSETCHAINS_HALVING[0]/1440,(long long)ASSETCHAINS_LASTERA);
        }
